    ...
    public partial class Autores : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                string msj = "NUEVO AUTOR";

                if (IdFolio != -1)
                {
                    string query = "select * from tbAutores where IdAutor = " + IdFolio;
                    ...
                    msj = "MODIFICAR AUTOR FOLIO: " + IdFolio;
                }
        ...
        protected void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "delete from tbAutores where IdAutor=" + IdFolio;
                FG.QueryBD(query);
        ...
        protected void btnModificar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (IdFolio == -1)
                {
                    query = "insert into tbAutores (descripcion) " +
